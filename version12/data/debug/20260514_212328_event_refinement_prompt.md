...
2. [OpenAI Blog｜产品与模型] How NVIDIA engineers and researchers build with Codex
...
候选事件ID：event_6
粗聚类标题：Nous Research's NousCoder-14B is an open-source coding model landing right in the Claude Code moment
来源：VentureBeat AI
类别：应用与商业
候选事件包含的新闻：
1. [VentureBeat AI｜应用与商业] Nous Research's NousCoder-14B is an open-source coding model landing right in the Claude Code moment
...
候选事件ID：event_8
粗聚类标题：Tencent plans to ramp up AI spending as China's chip supply allegedly improves
来源：The Decoder
类别：应用与产品
候选事件包含的新闻：
1. [The Decoder｜应用与产品] Tencent plans to ramp up AI spending as China's chip supply allegedly improves
   摘要：Tencent plans to significantly boost AI infrastructure spending in the second half of 2026, as Chinese chipmakers ramp up domestic AI chip production. The company also posted strong first-quarter results and is in talks 
   链接：https://the-decoder.com/tencent-plans-to-ramp-up-ai-spending-as-chinas-chip-supply-allegedly-improves/

---

候选事件ID：event_9
粗聚类标题：Building a safe, effective sandbox to enable Codex on Windows
来源：OpenAI Blog
类别：产品与模型
候选事件包含的新闻：
1. [OpenAI Blog｜产品与模型] Building a safe, effective sandbox to enable Codex on Windows
...
候选事件ID：event_11
粗聚类标题：AutoScout24 scales engineering with AI-powered workflows
来源：OpenAI Blog
类别：产品与模型
候选事件包含的新闻：
1. [OpenAI Blog｜产品与模型] AutoScout24 scales engineering with AI-powered workflows
...
候选事件ID：event_20
粗聚类标题：Salesforce rolls out new Slackbot AI agent as it battles Microsoft and Google in workplace AI
来源：VentureBeat AI
类别：应用与商业
候选事件包含的新闻：
...
候选事件ID：event_21
粗聚类标题：Anthropic launches Cowork, a Claude Desktop agent that works in your files — no coding required
来源：VentureBeat AI
类别：应用与商业
候选事件包含的新闻：
1. [VentureBeat AI｜应用与商业] Anthropic launches Cowork, a Claude Desktop agent that works in your files — no coding required
...
候选事件ID：event_23
粗聚类标题：Anthropic’s Cat Wu says that, in the future, AI will anticipate your needs before you know what they are
来源：TechCrunch AI
类别：应用与商业
候选事件包含的新闻：
1. [TechCrunch AI｜应用与商业] Anthropic’s Cat Wu says that, in the future, AI will anticipate your needs before you know what they are
...
候选事件ID：event_24
粗聚类标题：Who trusts Sam Altman?
来源：TechCrunch AI
类别：应用与商业
候选事件包含的新闻：
1. [TechCrunch AI｜应用与商业] Who trusts Sam Altman?
...
候选事件ID：event_26
粗聚类标题：New Claude Mythos becomes the first AI model to clear all cyberattack simulations from Britain's AI safety agency
来源：The Decoder
类别：应用与产品
候选事件包含的新闻：
1. [The Decoder｜应用与产品] New Claude Mythos becomes the first AI model to clear all cyberattack simulations from Britain's AI safety agency
...
候选事件ID：event_27
粗聚类标题：Claude subscriptions get separate budgets for programmatic use, billed at full API prices
来源：The Decoder
类别：应用与产品
候选事件包含的新闻：
1. [The Decoder｜应用与产品] Claude subscriptions get separate budgets for programmatic use, billed at full API prices
...
候选事件ID：event_28
粗聚类标题：Anthropic overtakes OpenAI in B2B adoption for the first time according to Ramp spending data
来源：The Decoder
类别：应用与产品
候选事件包含的新闻：
1. [The Decoder｜应用与产品] Anthropic overtakes OpenAI in B2B adoption for the first time according to Ramp spending data
   摘要：Anthropic now leads OpenAI in B2B adoption for the first time, with 34.4 percent of US companies on the Ramp AI Index compared to OpenAI's 32.3 percent. Anthropic quadrupled its reach in just one year, but three factors 
...
候选事件ID：event_31
粗聚类标题：Claude Code costs up to $200 a month. Goose does the same thing for free.
来源：VentureBeat AI
类别：应用与商业
候选事件包含的新闻：
1. [VentureBeat AI｜应用与商业] Claude Code costs up to $200 a month. Goose does the same thing for free.
...
候选事件ID：event_33
粗聚类标题：Musk’s xAI is running nearly 50 gas turbines unchecked at its Mississippi data center
来源：TechCrunch AI
类别：应用与商业
候选事件包含的新闻：
1. [TechCrunch AI｜应用与商业] Musk’s xAI is running nearly 50 gas turbines unchecked at its Mississippi data center
...
候选事件ID：event_34
粗聚类标题：How finance teams use Codex
来源：OpenAI Blog
类别：产品与模型
候选事件包含的新闻：
1. [OpenAI Blog｜产品与模型] How finance teams use Codex
...
候选事件ID：event_35
粗聚类标题：Listen Labs raises $69M after viral billboard hiring stunt to scale AI customer interviews
来源：VentureBeat AI
类别：应用与商业
候选事件包含的新闻：
1. [VentureBeat AI｜应用与商业] Listen Labs raises $69M after viral billboard hiring stunt to scale AI customer interviews
...
候选事件ID：event_39
粗聚类标题：AI chatbots are giving out people’s real phone numbers
来源：MIT Technology Review AI
类别：趋势与影响
候选事件包含的新闻：
1. [MIT Technology Review AI｜趋势与影响] AI chatbots are giving out people’s real phone numbers
